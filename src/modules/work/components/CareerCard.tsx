...
const CareerCard = ({
  ...
  return (
    <Card className="flex items-center gap-5 py-4 px-6 border border-neutral-300 dark:border-neutral-600 bg-cardlight dark:bg-carddark rounded-xl transition-all duration-300 shadow-sm">
      {logo ? (
        ...
        <div className="text-sm text-neutral-600 dark:text-neutral-400 space-y-2">
          ...
          <div className="flex flex-col md:text-[13px]">
            <div className="flex gap-1">
              <span>{format(start_date, "MMM yyy")}</span> -{" "}
              <span>{end_date ? format(endDate, "MMM yyy") : "Present"}</span>
            </div>
