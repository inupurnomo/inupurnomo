...
import { useTaskBoard } from "@/common/stores/board";
...
export default function TaskBoard() {
  ...
  const { runDriver, isProductTour } = createDrivers({
    steps: tourTaskBoard,
    product: "task-board",
  });
  ...
  return (
    ...
    >
      ...
      <div className="min-h-full md:min-h-[70vh] mt-8 flex w-full flex-col space-y-4 md:flex-row md:space-y-0">
        {hydrate ? (
