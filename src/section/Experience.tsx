...
export default function Experience() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-screen max-w-contentContainer flex-col content-center gap-4 py-10 md:px-6 mdl:pl-28 mdl:pr-16 lgl:pr-12 lgl:gap-8 xl:pl-52">
