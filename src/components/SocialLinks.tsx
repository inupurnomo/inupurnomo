...
export default function SocialLinks({page}: any) {
  const {currentSection} = useSection();
  return (
    <>
      {page === "index" ? (
        <div className="hidden z-20 fixed left-10 bottom-1/3 md:flex flex-col w-6 h-52 items-center justify-between">
          {navLinks.map((nav) => {
            return (
              <a
                title={nav.text}
...
const socialLinks = [
  {
    ...
    link: "https://github.com/inupurnomo",
    svg: (
      <svg
  ...
  },
  {
    ...
    link: "https://www.linkedin.com/in/inupurnomo/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    ...
    link: "https://www.facebook.com/inupurnomo.official",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
