...
export default function Experience() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-screen max-w-contentContainer flex-col content-center gap-4 px-12 py-10 mdl:pr-16 mdl:pl-28 lgl:gap-8 xl:pl-52 lg:pr-0">
