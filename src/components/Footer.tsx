...
export default function Footer({noPadding = false}: Props) {
  return (
    <footer
    ...
    >
      ...
      <div className="w-full max-w-contentContainer mx-auto flex justify-between items-center px-16 mb-6">
...
const socialLinks = [
  ...
  },
  {
    ...
    link: "https://www.facebook.com/inupurnomo",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
