...
import useScrollListener from "@/common/hooks/useScrollListener";
import { useSection } from "@/common/context/section";

import { NAVLINK } from "@/common/constant/navlink";
    ...
    <header className="md:flex">
      ...
      >
        <div className="w-full h-full mx-auto max-w-6xl flex items-center justify-between">
          <Link
            href="/"
            className="text-xl sm:text-2xl md:hover:text-marrsgreen dark:md:hover:text-carrigreen focus-visible:outline-marrsgreen dark:focus-visible:outline-carrigreen duration-300"
          >
            diggy
